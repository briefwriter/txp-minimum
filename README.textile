***Please note that this is a "testing branch" that most likely have some errors, but seems to work at first glance, and after giving it a quick once through online.
**Form "global_variables" must be filled out before once loaded onto your site before template will work with all its features that were added.
h1. txp-minimum
